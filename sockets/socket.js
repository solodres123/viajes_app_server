...
const Componentes = require('../services/componentes/componentes')
const Componente = require('../models/componentes/componente')
const componentes = new Componentes();
const Habitaciones = require('../services/componentes/habitaciones/habitaciones')
const Habitacion = require('../models/componentes/habitaciones/habitacion')
const habitaciones = new Habitaciones();
const Camas = require('../services/componentes/habitaciones/camas')
...
const Deudas = require('../services/componentes/deudas/deudas');
const Deuda = require('../models/componentes/deudas/deuda');
const deudas = new Deudas();
const Tareas = require('../services/componentes/tareas/tareas');
const Tarea = require('../models/componentes/tareas/tarea');
const tareas = new Tareas();
const ItemsGrupal = require('../services/componentes/items_grupal/items_grupal');
const ItemGrupal = require('../models/componentes/items_grupal/item_grupal');
const itemsGrupal = new ItemsGrupal();
const Eventos = require('../services/componentes/calendario/eventos');
const Evento = require('../models/componentes/calendario/evento');
const eventos = new Eventos();
const Calendarios = require('../services/componentes/calendario/calendarios');
...
const Confirmaciones = require('../services/componentes/confirmaciones/confirmaciones');
...
const UsuarioOcupaCamas = require('../services/componentes/habitaciones/usuario_ocupa_camas');
const Asignacion = require('../models/componentes/items_grupal/asignacion');
const ItemsCompra = require('../services/componentes/compra/items_compra');
